...
def _get_default_rules(dataset: str, engine_llm: str) -> List[str]:
    ...
    # Default rules for Researchy-GEO (research queries) gpt (gpt-4.1-mini)
    ...
    # Default rules for GEO-Bench (research queries) gpt (gpt-4.1-mini)
    ...
    # Default rules for E-commerce (commercial queries) gpt (gpt-4.1-mini)
