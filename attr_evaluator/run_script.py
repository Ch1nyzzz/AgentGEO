...
if __name__ == "__main__":
    ...
    argparser.add_argument('--attack_mode', type=str, default=None, help='attack mode')
    ...
    argparser.add_argument('--n-demos', type=int, default=0, help='number of ICL examples (default 2)')
